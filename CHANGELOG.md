...
- GitHub showcase tree: bilingual README (zh-Hant / en), gameplay and installation notes, MIT licence, contributing guide, hero artwork, and English-named demo plates under `docs/assets/`.
